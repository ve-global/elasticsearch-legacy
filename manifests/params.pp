...
#
class elasticsearch_legacy::params {
  ...
  case $::kernel {
    'Linux': {
      $elasticsearch_legacy_user  = 'elasticsearch'
      $elasticsearch_legacy_group = 'elasticsearch'
    }
    'Darwin': {
      $elasticsearch_legacy_user  = 'elasticsearch'
      $elasticsearch_legacy_group = 'elasticsearch'
    ...
    'OpenBSD': {
      $elasticsearch_legacy_user  = '_elasticsearch'
      $elasticsearch_legacy_group = '_elasticsearch'
    }
    default: {
